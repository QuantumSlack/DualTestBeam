...
# python massjobs.py -g DualTestBeam -N 500 -d 2 -o 3 -c /data/users/eno/CalVision/dd4hep/gitlab/DualTestBeam/compact/ -w /data/users/eno/CalVision/dd4hep/gitlab/DualTestBeam/compact/output/  -s /data/users/eno/CalVision/dd4hep/gitlab/DualTestBeam/compact/jobs/
...
argParser.add_argument("-d", "--direction", help="0 is straight, 1 is 0.05, 2 is 0.0125")
argParser.add_argument("-o", "--origin", help="0 is 0,0,-1  1 is 0,-7,-1  2 is 0,0,-80 3 is 0,-1.5,-80")
...
while (i<nenergy):
    print(i)
    yuck=str(scriptarea)+str(name)+str(energies[i])+'_GeV-e.sh'
    print(yuck)
